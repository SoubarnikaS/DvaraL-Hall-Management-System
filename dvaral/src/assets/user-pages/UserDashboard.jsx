...
const UserDashboard = () => {
  const sidebarLinks = [
    { name: "Explore Halls", icon: Search },
    { name: "Reserved Halls", icon: BookMarked },
            ...
            <ul>
              {sidebarLinks.map((link, index) => (
                <li key={index} className="mb-2">
                  <a href="#" className="flex items-center px-6 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition duration-200">
